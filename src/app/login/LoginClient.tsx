      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md bg-white/90 backdrop-blur-sm shadow-lg border border-slate-200">
          ...
          <CardContent className="pt-4 pb-4">
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="h-11 pr-10 focus:border-slate-900 focus-visible:ring-2 focus-visible:ring-slate-300" />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="h-11 pr-10 focus:border-slate-900 focus-visible:ring-2 focus-visible:ring-slate-300" />
            ...
            <div className="mt-3">
              <Button type="button" onClick={handleKakaoLogin} className="w-full h-11 bg-[#FEE500] text-black hover:bg-[#FADA0A] cursor-pointer transform transition-transform duration-300 ease-out hover:scale-105 active:scale-[0.98]" disabled={loading}>
                카카오로 로그인
              </Button>
            </div>
